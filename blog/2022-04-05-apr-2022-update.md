...
Infracost [v0.9.21](https://www.infracost.io/docs/#1-install-infracost) is live! We added added support for cost policies into the CLI and pull request comments, added many new resources, and updated the Jenkins and CircleCI integrations to support the latest features.
