...
We [announced](/blog/terraform-cost-estimation-with-runtasks-infracost/) the public launch of our direct integration into Terraform Cloud using the new Terraform run tasks feature. Checkout the [discussion and demo video](https://www.youtube.com/watch?v=UVAadtvsYSk) we recorded together with HashiCorp!
