...
If you used our old [infracost-gh-actions](https://github.com/infracost/infracost-gh-action) repo, please follow our [migration guide](/docs/guides/actions_migration) to use the new [actions](https://github.com/infracost/actions/) repo. The infracost-gh-actions repo will be deprecated in the next Infracost release but will continue to work without issues.
