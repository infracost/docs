...
title: "November update: New composable GitHub Actions and improved pull request comments"
...
**Summary: today we're excited to announce Infracost v0.9.14 🎉  This release includes improved CLI output, 6 new AWS/Azure/Google resources, faster runs, a summary table in PR comments, and new `github-comment` and `slack-message` output formats. We're also announcing our new composable GitHub Actions - we recommend everyone to [upgrade](/docs/#1-install-infracost)!**
