...
Today we're excited to announce **Infracost v0.9.14** 🎉 This release includes many new features, some of which were developed to support our new composable GitHub Actions. We recommend everyone to [upgrade](/docs/#1-install-infracost).
