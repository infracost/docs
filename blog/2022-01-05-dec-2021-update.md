...
There are a few use cases in which sharing a cost estimate with others is really helpful. This could be to a collegue to check over changes, to a manager to set expecations of a cost spike due to infrastructure changes on the way, or for doing what-if analysis by creating multiple cost estimates with different options and sending them to internal or external clients.

I'm very excited to announce that you can now automatically create sharable links!

[Here is a live example:](https://dashboard.infracost.io/share/deaczrvclzv9z8yf76dex0t4dpxx9buj)
