...
<img
  ...
  alt="Default config file used by all repos in the GitHub App or GitLab App integration"
/>
...
<details>
  <summary>Looping over projects with complex `matchPaths` matchers</summary>
