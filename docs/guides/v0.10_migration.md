...
2. HCL parsing does not work with modules that have a `source` in a private Terraform registry. Private git modules work ok. Subscribe to [this issue](https://github.com/infracost/infracost/issues/1667) for updates.
