...
4. If you use private modules:
   ...
   - For private **registry modules**, see [this page](/docs/features/terraform_modules/#registry-modules) and set the required Terraform registry token and host in the integration settings page in Infracost Cloud.
