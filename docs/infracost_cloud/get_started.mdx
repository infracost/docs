...
<img
  src={useBaseUrl('img/infracost-cloud/dashboard-chart.png')}
  alt="Team visibility across all changes"
/>
...
<img
  src={useBaseUrl('img/infracost-cloud/pull-requests-tab.png')}
  alt="Infracost Cloud shows pull request cost changes"
/>
