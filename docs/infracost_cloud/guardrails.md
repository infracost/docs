...
3. **Budget: New monthly cost**: triggered when a pull request crosses this threshold from below to above. For example, trigger when a change would push costs from $9,500 to $10,500 (crossing the $10,000 threshold).
