...
<img
  src={useBaseUrl('img/infracost-cloud/tagging-policies/name-and-scope.png')}
  alt="Define tagging policy name and scope."
/>
...
<img
  src={useBaseUrl('img/infracost-cloud/tagging-policies/define-tags.png')}
  alt="Define tag keys and values."
/>
...
<img
  src={useBaseUrl('img/infracost-cloud/tagging-policies/actions-to-take.png')}
  alt="You can optionally block pull requests that fail a policy."
/>
...
<img
  src={useBaseUrl('img/infracost-cloud/tagging-policies/customizations.png')}
  alt="You can customize the pull request message."
/>
...
<img
  src={useBaseUrl('img/infracost-cloud/tagging-policies/filters.png')}
  alt="Create a tagging policy using pull request filters."
/>
...
<img
  src={useBaseUrl('img/infracost-cloud/tagging-policies/branch-policies.png')}
  alt="Infracost Cloud shows you any tagging policy failures that are currently happening on your main or master branch too."
/>
...
<img
  src={useBaseUrl('img/infracost-cloud/tagging-policies/coverage-chart.png')}
  alt="Infracost Cloud shows you the percentage of resources that are passing your tagging policies."
/>
...
<img
  src={useBaseUrl('img/infracost-cloud/tagging-policies/pull-request-tags.png')}
  alt="Create a pull request to test your tagging policy."
/>
