...
<Tabs
  ...
  infracost --version # Should show 0.10.26
  ```
...
<ol type="i">
  ...
  It gives team leads, managers and FinOps practitioners dashboards, guardrails and centralized cost policies so they can help guide the team. For example, you can check for required tag keys/values, or switch AWS GP2 volumes to GP3.</li>
