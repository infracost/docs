      ...
      <div className="questions__columns">
        <ul className="questions__column">
          ...
          <QuestionLi>
            ...
            <Answer>
              No. You can start with Infracost CI/CD, start seeing cloud
          ...
          <QuestionLi>
            ...
            <Answer>
              ...
              Cloud, or keep using Infracost CI/CD with no disruption for free. Visit our pricing page for more information.
            </Answer>
          </QuestionLi>
        </ul>
        ...
        <ul className="questions__column">
          <QuestionLi>
            ...
            <Answer>
              ...
              Infracost CI/CD (join our community Slack <a href="https://infracost.io/community-chat">here</a>). We also
          ...
          <QuestionLi>
            ...
            <Answer>
              You can self-host Infracost CI/CD, but Infracost Cloud is
