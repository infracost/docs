      ...
      <div className="team">
          ...
          <div className="profiles">
            <div className="profile">
              ...
              <div className="social">
                <a
                  className="twitter"
                  href="https://twitter.com/hassankhosseini"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Hassan's Twitter"
                >
                  <span className="icon">
                    <TwitterIcon />
                  </span>
                ...
                <a
                  className="linkedin"
                  href="https://www.linkedin.com/in/hassanhosseini/"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="profile">
              ...
              <div className="social">
                <a
                  className="twitter"
                  href="https://twitter.com/alikhajeh"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Ali's Twitter"
                >
                  <span className="icon">
                    <TwitterIcon />
                  </span>
                ...
                <a
                  className="linkedin"
                  href="https://www.linkedin.com/in/alikhajeh1/"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="profile">
              ...
              <div className="social">
                <a
                  className="twitter"
                  href="https://twitter.com/aliscott"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Alistair's Twitter"
                >
                  <span className="icon">
                    <TwitterIcon />
                  </span>
                ...
                <a
                  className="linkedin"
                  href="https://www.linkedin.com/in/aiscott/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Alistair's LinkedIn"
                >
                  <span className="icon">
                    <LinkedInIcon />
                  </span>
            ...
            <div className="profile">
              ...
              <div className="social">
                <a
                  className="linkedin"
                  href="https://www.linkedin.com/in/tim-mcfadden-92672633/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Tim's LinkedIn"
                >
                  <span className="icon">
                    <LinkedInIcon />
                  </span>
            ...
            <div className="profile">
              ...
              <div className="social">
                <a
                  className="twitter"
                  href="https://twitter.com/vdmgolub"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Vadim's Twitter"
                >
                  <span className="icon">
                    <TwitterIcon />
                  </span>
                ...
                <a
                  className="linkedin"
                  href="https://www.linkedin.com/in/vdmgolub/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Vadim's LinkedIn"
                >
                  <span className="icon">
                    <LinkedInIcon />
                  </span>
            ...
            <div className="profile">
              ...
              <div className="social">
                <a
                  className="twitter"
                  href="https://twitter.com/hugo_rut"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Hugo's Twitter"
                >
                  <span className="icon">
                    <TwitterIcon />
                  </span>
                ...
                <a
                  className="linkedin"
                  href="https://www.linkedin.com/in/hugo-rut-13111680/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Hugo's LinkedIn"
                >
                  <span className="icon">
                    <LinkedInIcon />
                  </span>
          ...
          <div className="container">
            ...
            <div className="backer-list">
              <div className="backer-item">
                <a
                  href="https://www.ycombinator.com/companies/infracost"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <div className="backer-item">
                <a
                  href="https://www.sequoiacap.com/companies/infracost/"
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className="contributors">
          <div className="container">
            ...
            <img
              src="https://contrib.rocks/image?repo=infracost/infracost"
              alt="Infracost's contributors"
            />
          </div>
        </div>
      </div>
