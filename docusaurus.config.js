  ...
  themeConfig: {
    ...
    announcementBar: {
      ...
      content:
        ...
        '<span class="announcement-message">As a thank you to our open-source community, Infracost is now only <a rel="noopener noreferrer" href="/pricing">$30 till end of the year</a>! 💸</span>',
